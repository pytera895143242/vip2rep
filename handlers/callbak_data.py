...
async def check(call: types.callback_query):
    ...
    if (
            proverka1 == 'member' and proverka2 == 'member' and proverka3 == 'member') or proverka1 == 'administrator' or proverka2 == 'administrator' or proverka3 == 'administrator':  # Человек прошел все 3 проверки
